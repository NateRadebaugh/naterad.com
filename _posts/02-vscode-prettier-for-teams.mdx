---
slug: vscode-prettier-for-teams
title: Configuring VSCode for Prettier
...
**Note:** If you're working with a large project that hasn't fully been migrated to use prettier for the whole setup, adding directory-level configuration files enables granular migration to prettier.
