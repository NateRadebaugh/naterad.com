...
(function(a, b) {
  ...
  function q(a, b, c, e) {
    ...
    typeof g.overrideMimeType == "function" &&
      g.overrideMimeType("text/css"), g.open("GET", a, h), g.setRequestHeader(
      "Accept",
        ...
        document.body &&
          (
            document.getElementById(c)
              ? document.body.replaceChild(f, document.getElementById(c))
  ...
  {}.toString.call(environment) === "[object Environment]"
    ...
    function t(a) {
      ...
      if (c) {
        ...
        return (k[g] = k[g].slice(e + (f - o))), (l = f), k[g].length === 0 &&
          g < k.length - 1 &&
    ...
    function A(a, b) {
      ...
      (this.type = a.type || "Syntax"), (this.message =
        a.message), (this.filename = a.filename || b.filename), (this.index =
        a.index), (this.line =
          ...
          this.queue.push(b), d.Parser.importer(
            ...
            function(a, d, f) {
              e.queue.splice(e.queue.indexOf(b), 1), (e.files[
                b
              ] = d), (e.contents[b] = f), a && !e.error && (e.error = a), c(
                a,
                d
              ), e.queue.length === 0 && o();
            },
        ...
        (f = g = l = j = 0), (b = h.replace(/\r\n/g, "\n")), (k = (function(c) {
          ...
          for (var l = 0, m, n; l < b.length; l++) {
            (e.lastIndex = l), (i = e.exec(b)) &&
              ...
              i.index === l &&
              ((l += i[0].length), j.push(i[0]), (m = b.charAt(l))), !k &&
              m === "/" &&
              (
                (n = b.charAt(l + 1)),
                (n === "/" || n === "*") &&
      ...
      parsers: {
        ...
        entities: {
          ...
          dataURI: function() {
            var a;
            if (t(/^data:/)) {
              (a = {}), (a.mime = t(/^[^\/]+\/[^,;)]+/) || ""), (a.charset =
                t(/^;\s*charset=[^,;)]+/) || ""), (a.base64 =
                t(/^;\s*base64/) || ""), (a.data = t(/^,\s*[^)]+/));
              if (a.data) return a;
            }
          },
          variable: function() {
        ...
        mixin: {
          ...
          definition: function() {
            ...
            if (
              ...
              u(")"), t(/^when/) &&
                (j = u(this.conditions, "expected condition")), (g = t(
                this.block
              ));
        ...
        rule: function() {
          ...
          if ((a = t(this.variable) || t(this.property))) {
            a.charAt(0) != "@" && (l = /^([^@+\/'"*`(;{}-]*);/.exec(k[g]))
              ? ((f += l[0].length - 1), (c = new e.Anonymous(l[1])))
              : a === "font" ? (c = t(this.font)) : (c = t(this.value)), (h = t(
              this.important
            ));
        ...
        condition: function() {
          ...
          if (
            ...
            return (d = t(/^(?:>=|=<|[<=>])/))
              ...
              : (c = new e.Condition("=", a, new e.Keyword("true"), g, h)), u(
              ")"
            ), t(/^and/) ? new e.Condition("and", c, t(this.condition)) : c;
        },
        operand: function() {
          var a,
            c = b.charAt(f + 1);
  ...
  (function(a) {
    ...
    (a.Directive = function(b, c, d) {
      ...
      eval: function(a) {
        return a.frames.unshift(this), (this.ruleset =
          this.ruleset && this.ruleset.eval(a)), a.frames.shift(), this;
      },
      variable: function(b) {
    ...
    (a.Element = function(b, c, d) {
      (this.combinator =
        b instanceof a.Combinator ? b : new a.Combinator(b)), typeof c ==
      "string"
        ? (this.value = c.trim())
    ...
    (a.Media = function(b, c) {
      ...
      eval: function(b) {
        ...
        return (d.features = this.features.eval(b)), b.frames.unshift(
          this.ruleset
        ), (d.ruleset = this.ruleset.eval(b)), b.frames.shift(), (b.mediaBlocks[
          c
        ...
        for (c = 0; c < e.length; c++)
          (d =
            e[c].features instanceof a.Value
              ? e[c].features.value
              : e[c].features), (e[c] = Array.isArray(d) ? d : [d]);
    ...
    (a.mixin = {}), (a.mixin.Call = function(b, c, d, e, f) {
              ...
              if (b[g].match(c, a))
                try {
                  Array.prototype.push.apply(
                    d,
                    b[g].eval(a, this.arguments, this.important).rules
                  ), (e = !0);
                } catch (h) {
                  throw {
                    message: h.message,
      ...
      match: function(a, b) {
        ...
        for (var f = 0; f < d; f++)
          if (
            !this.params[f].name &&
            a[f].eval(b).toCSS() != this.params[f].value.eval(b).toCSS()
          )
            return !1;
        return !0;
      }
    ...
    (a.Rule = function(b, c, d, e, f) {
      (this.name = b), (this.value =
        c instanceof a.Value ? c : new a.Value([c])), (this.important = d
        ? " " + d.trim()
        : ""), (this.index = e), (this.inline = f || !1), b.charAt(0) === "@"
        ? (this.variable = !0)
        : (this.variable = !1);
    ...
    (a.Ruleset = function(a, b, c) {
                ...
                if (e !== c)
                  for (var g = 0; g < e.selectors.length; g++)
                    if ((f = b.match(e.selectors[g]))) {
                      b.elements.length > e.selectors[g].elements.length
                        ? Array.prototype.push.apply(
                            d,
                            e.find(new a.Selector(b.elements.slice(1)), c)
                          )
                        : d.push(e);
                      break;
                    }
        ...
        for (var j = 0; j < this.rules.length; j++)
          ...
          i instanceof a.Media
            ...
            : i instanceof a.Comment
              ? i.silent ||
                (this.root ? f.push(i.toCSS(c)) : e.push(i.toCSS(c)))
              : i.toCSS && !i.variable
                ? e.push(i.toCSS(c))
                : i.value && !i.variable && e.push(i.value.toString());
      ...
      joinSelector: function(b, c, d) {
        ...
        i || ((h = g), (g = [])), g.length > 0 &&
          e.push(new a.Selector(g)), h.length > 0 && f.push(new a.Selector(h));
    ...
    (b.URL = function(b, c) {
      b.data
        ...
        : (
            typeof a != "undefined" &&
              !/^(?:https?:\/\/|file:\/\/|data:|\/)/.test(b.value) &&
              c.length > 0 &&
              (b.value =
                c[0] +
                (b.value.charAt(0) === "/" ? b.value.slice(1) : b.value)),
            (this.value = b),
            (this.paths = c)
          );
    }), (b.URL.prototype = {
