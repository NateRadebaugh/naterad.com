...
(function(a, b) {
    ...
    function l() {
        ...
        for (var b = 0; b < a.length; b++)
            a[b].type.match(j) &&
                new d.Parser().parse(a[b].innerHTML || "", function(c, d) {
                    var e = d.toCSS(),
                        f = a[b];
                    (f.type =
                        "text/css"), f.styleSheet ? (f.styleSheet.cssText = e) : (f.innerHTML = e);
                });
    }
    function m(a, b) {
    ...
    function n(b, c, e, f) {
        ...
        /^(https?|file):/.test(i) ||
            (i.charAt(0) == "/"
                ? (i = a.location.protocol + "//" + a.location.host + i)
                : (i = h.slice(0, h.lastIndexOf("/") + 1) + i));
        var m = i.match(/([^\/]+)$/)[1];
        q(
            b.href,
            b.type,
            function(a, g) {
                if (
                    ...
                    l &&
                    g &&
                    new Date(g).valueOf() === new Date(l.timestamp).valueOf()
                )
    ...
    function p(a, b, c) {
        var d,
            e = b.href ? b.href.replace(/\?.*$/, "") : "",
            f = "less:" + (b.title || o(e));
        (d = document.getElementById(f)) === null &&
            (
                (d = document.createElement("style")),
                (d.type = "text/css"),
                (d.media = b.media || "screen"),
                (d.id = f),
        ...
        if (d.styleSheet)
            ...
            (function(a) {
                d.childNodes.length > 0
                    ? d.firstChild.nodeValue !== a.nodeValue &&
                      d.replaceChild(a, d.firstChild)
                    : d.appendChild(a);
    ...
    function q(a, b, c, e) {
        ...
        var g = r(),
            h = f ? !1 : d.async;
        typeof g.overrideMimeType == "function" &&
            g.overrideMimeType("text/css"), g.open(
            "GET",
            a,
            h
        ), g.setRequestHeader(
            ...
            ? g.status === 0 || (g.status >= 200 && g.status < 300)
              ? c(g.responseText)
              : e(g.status, a)
            : h
    ...
    function u(a, b) {
        var c = "less-error-message:" + o(b),
            ...
            i = [],
            j = a.filename || b;
        (f.id = c), (f.className = "less-error-message"), (h =
            "<h3>" +
        ...
        var k = function(a, b, c) {
            a.extract[b] &&
                i.push(
                    e
                        .replace(/\{line\}/, parseInt(a.line) + (b - 1))
                        .replace(/\{class\}/, c)
    ...
    {}.toString.call(environment) === "[object Environment]"
        ? (
              typeof a == "undefined" ? (d = {}) : (d = a.less = {}),
              (e = d.tree = {}),
              (d.mode = "rhino")
          )
        : typeof a == "undefined"
          ? ((d = exports), (e = c("./tree")), (d.mode = "node"))
          : (
                typeof a.less == "undefined" && (a.less = {}),
                (d = a.less),
                (e = a.less.tree = {}),
                (d.mode = "browser")
            ), (d.Parser = function v(a) {
        function q() {
            (h = k[g]), (i = f), (l = f);
        }
        function r() {
        ...
        function t(a) {
            ...
            if (c) {
                ...
                return (k[g] = k[g].slice(e + (f - o))), (l = f), k[g]
                    .length === 0 &&
                    g < k.length - 1 &&
                    g++, typeof c == "string" ? c : c.length === 1 ? c[0] : c;
            }
        }
        function u(a, c) {
            var d = t(a);
        ...
        function y(a, c) {
            return a.filename && c.filename && a.filename !== c.filename
                ? m.imports.contents[x(a.filename)]
                : b;
        }
        function z(a, b) {
        ...
        function A(a, b) {
            var c = y(a, b),
                ...
                f = d.column,
                g = c.split("\n");
            (this.type = a.type || "Syntax"), (this.message =
                a.message), (this.filename =
                a.filename || b.filename), (this.index = a.index), (this.line =
                typeof e == "number" ? e + 1 : null), (this.callLine =
                a.call && z(a.call, c).line + 1), (this.callExtract =
                g[z(a.call, c).line]), (this.stack =
                a.stack), (this.column = f), (this.extract = [
                g[e - 1],
                g[e],
                g[e + 1]
            ]);
        ...
        var b,
            ...
            p = (this.imports = {
                ...
                push: function(b, c) {
                    var e = this;
                    this.queue.push(b), d.Parser.importer(
                        b,
                        this.paths,
                        function(a, d, f) {
                            e.queue.splice(e.queue.indexOf(b), 1), (e.files[
                                b
                            ] = d), (e.contents[b] = f), a &&
                                !e.error &&
                                (e.error = a), c(a, d), e.queue.length === 0 &&
                                o();
                        },
                        a
                    );
        ...
        return (this.env = a = a || {}), (this.optimization =
            "optimization" in this.env
                ? this.env.optimization
                : 1), (this.env.filename = this.env.filename || null), (m = {
            imports: p,
            parse: function(h, i) {
                var n,
                    p,
                ...
                (f = g = l = j = 0), (b = h.replace(
                    ...
                    for (var l = 0, m, n; l < b.length; l++) {
                        (e.lastIndex = l), (i = e.exec(b)) &&
                            i.index === l &&
                            ((l += i[0].length), j.push(i[0])), (m = b.charAt(
                            l
                        )), (f.lastIndex = g.lastIndex = l), (i = g.exec(b)) &&
                            i.index === l &&
                            (
                                (l += i[0].length),
                                j.push(i[0]),
                ...
                n.toCSS = (function(b) {
                    ...
                    return function(f, g) {
                        ...
                        try {
                            var j = b
                                .call(this, { frames: h })
                                .toCSS([], { compress: f.compress || !1 });
                        } catch (k) {
                            throw new A(k, a);
                        }
                        if ((i = m.imports.error))
                            throw i instanceof A ? i : new A(i, a);
                        return f.yuicompress && d.mode === "node"
                            ? c("./cssmin").compressor.cssmin(j)
                            : f.compress ? j.replace(/(\s)+/g, "$1") : j;
                    };
                })(n.eval);
                if (f < b.length - 1) {
                    (f = j), (u = b.split("\n")), (s =
            ...
            parsers: {
                ...
                entities: {
                    ...
                    keyword: function() {
                        ...
                        if ((a = t(/^[_A-Za-z-][_A-Za-z0-9-]*/)))
                            return e.colors.hasOwnProperty(a)
                                ? new e.Color(e.colors[a].slice(1))
                                : new e.Keyword(a);
                    },
                    call: function() {
                        var b,
                    ...
                    literal: function() {
                        return (
                            t(this.entities.dimension) ||
                            t(this.entities.color) ||
                            t(this.entities.quoted)
                        );
                    },
                    assignment: function() {
                        var a, b;
                    ...
                    url: function() {
                        ...
                        return (a =
                            t(this.entities.quoted) ||
                            t(this.entities.variable) ||
                            t(this.entities.dataURI) ||
                            t(/^[-\w%@$\/.&=:;#+?~]+/) ||
                            ""), u(")"), new e.URL(
                            a.value || a.data || a instanceof e.Variable
                                ? a
                                : new e.Anonymous(a),
                            p.paths
                        );
                ...
                mixin: {
                    call: function() {
                        ...
                        t("(") && (h = t(this.entities.arguments)) && t(")"), t(
                            this.important
                        ) && (k = !0);
                        if (c.length > 0 && (t(";") || w("}")))
                            return new e.mixin.Call(
                                c,
                                h || [],
                                i,
                                a.filename,
                        ...
                        if (
                            ...
                            do {
                                ...
                                if (
                                    !(h =
                                        t(this.entities.variable) ||
                                        t(this.entities.literal) ||
                                        t(this.entities.keyword))
                                )
                                    break;
                ...
                entity: function() {
                    return (
                        ...
                        t(this.entities.variable) ||
                        t(this.entities.url) ||
                        t(this.entities.call) ||
                        t(this.entities.keyword) ||
                        t(this.entities.javascript) ||
                        t(this.comment)
                    );
                },
                end: function() {
                ...
                selector: function() {
                    var a,
                        ...
                        h;
                    if (t("("))
                        return (a = t(this.entity)), u(")"), new e.Selector([
                            new e.Element("", a, f)
                        ]);
                ...
                attribute: function() {
                    ...
                    if ((b = t(/^[a-zA-Z-]+/) || t(this.entities.quoted)))
                        (d = t(/^[|~*$^]?=/)) &&
                        (c = t(this.entities.quoted) || t(/^[\w-]+/))
                            ? (a = [b, d, c.toCSS ? c.toCSS() : c].join(""))
                            : (a = b);
                    if (!t("]")) return;
                    if (a) return "[" + a + "]";
                },
                ...
                rule: function() {
                    ...
                    if ((a = t(this.variable) || t(this.property))) {
                        ...
                        (l = /^([^@+\/'"*`(;{}-]*);/.exec(k[g]))
                            ? (
                                  (f += l[0].length - 1),
                                  (c = new e.Anonymous(l[1]))
                              )
                            : a === "font"
                              ? (c = t(this.font))
                              : (c = t(this.value)), (h = t(this.important));
                ...
                import: function() {
                    ...
                    if (
                        t(/^@import\s+/) &&
                        (a = t(this.entities.quoted) || t(this.entities.url))
                    ) {
                ...
                mediaFeature: function() {
                    ...
                    do
                        if ((a = t(this.entities.keyword))) c.push(a);
                            ...
                            if (b && a)
                                c.push(
                                    new e.Paren(new e.Rule(b, a, null, f, !0))
                                );
                    ...
                    if (
                        ...
                        return (d = t(/^(?:>=|=<|[<=>])/))
                            ? (b =
                                  ...
                                  t(this.entities.keyword) ||
                                  t(this.entities.quoted))
                              ? (c = new e.Condition(d, a, b, g, h))
                              : v("expected expression")
                            : (c = new e.Condition(
                                  "=",
                                  a,
                                  new e.Keyword("true"),
                            ...
                            ? new e.Condition("and", c, t(this.condition))
                            : c;
                },
                operand: function() {
                    var a,
                    ...
                    var d =
                        ...
                        t(this.entities.call);
                    return a
                        ? new e.Operation("*", [new e.Dimension(-1), d])
                        : d;
                },
                expression: function() {
                    var a,
    ...
    if (d.mode === "browser" || d.mode === "rhino")
        d.Parser.importer = function(a, b, c, d) {
            !/^([a-z]+:)?\//.test(a) && b.length > 0 && (a = b[0] + a), n(
                { href: a, title: a, type: d.mime },
                function(e) {
                    e && typeof d.errback == "function"
                        ? d.errback.call(null, a, b, c, d)
    ...
    (function(a) {
        ...
        a.functions = {
            ...
            hsla: function(a, b, d, e) {
                function h(a) {
                    return (a = a < 0 ? a + 1 : a > 1 ? a - 1 : a), a * 6 < 1
                        ? g + (f - g) * a * 6
                        : a * 2 < 1
                          ? f
                          : a * 3 < 2 ? g + (f - g) * (2 / 3 - a) * 6 : g;
                }
                (a = c(a) % 360 / 360), (b = c(b)), (d = c(d)), (e = c(e));
                var f = d <= 0.5 ? d * (b + 1) : d + b - d * b,
                    g = d * 2 - f;
                return this.rgba(
                    h(a + 1 / 3) * 255,
                    h(a) * 255,
            ...
            e: function(b) {
                return new a.Anonymous(
                    b instanceof a.JavaScript ? b.evaluated : b
                );
            },
            escape: function(b) {
                return new a.Anonymous(
            ...
            "%": function(b) {
                ...
                return (d = d.replace(/%%/g, "%")), new a.Quoted(
                    '"' + d + '"',
                    d
                );
            },
            ...
            ispixel: function(b) {
                return b instanceof a.Dimension && b.unit === "px"
                    ? a.True
                    : a.False;
            },
            ispercentage: function(b) {
                return b instanceof a.Dimension && b.unit === "%"
                    ? a.True
                    : a.False;
            },
            isem: function(b) {
                return b instanceof a.Dimension && b.unit === "em"
                    ? a.True
                    : a.False;
            },
            _isa: function(b, c) {
        ...
        (a.Alpha = function(a) {
            ...
            eval: function(a) {
                return this.value.eval &&
                    (this.value = this.value.eval(a)), this;
            }
        });
    })(c("../tree")), (function(a) {
                    ...
                    : "#" +
                      this.rgb
                          .map(function(a) {
                              return (a = Math.round(
                                  a
                              )), (a = (a > 255 ? 255 : a < 0 ? 0 : a).toString(16)), a.length === 1 ? "0" + a : a;
                          })
                          .join("");
            },
        ...
        (a.Dimension = function(a, b) {
            ...
            operate: function(b, c) {
                return new a.Dimension(
                    a.operate(b, this.value, c.value),
                    this.unit || c.unit
                );
            },
            compare: function(b) {
                return b instanceof a.Dimension
                    ? b.value > this.value ? -1 : b.value < this.value ? 1 : 0
                    : -1;
            }
        });
    })(c("../tree")), (function(a) {
        (a.Directive = function(b, c, d) {
            ...
            eval: function(a) {
                return a.frames.unshift(this), (this.ruleset =
                    this.ruleset &&
                    this.ruleset.eval(a)), a.frames.shift(), this;
            },
            variable: function(b) {
        ...
        (a.Element = function(b, c, d) {
            (this.combinator =
                b instanceof a.Combinator
                    ? b
                    : new a.Combinator(b)), typeof c == "string"
                ? (this.value = c.trim())
                : c ? (this.value = c) : (this.value = ""), (this.index = d);
            ...
            return (
                this.combinator.toCSS(a || {}) +
                (this.value.toCSS ? this.value.toCSS(a) : this.value)
            );
        ...
        (a.Import = function(b, c, d, e) {
            var f = this;
            (this.index = e), (this._path = b), (this.features =
                d && new a.Value(d)), b instanceof a.Quoted
                ? (this.path = /\.(le?|c)ss(\?.*)?$/.test(b.value)
                      ? b.value
                      : b.value + ".less")
                : (this.path =
                      b.value.value || b.value), (this.css = /css(\?.*)?$/.test(
                this.path
            )), this.css ||
                c.push(this.path, function(b, c) {
            ...
            eval: function(b) {
                ...
                for (var e = 0; e < c.rules.length; e++)
                    c.rules[e] instanceof a.Import &&
                        Array.prototype.splice.apply(
                            c.rules,
                            [e, 1].concat(c.rules[e].eval(b))
                        );
        ...
        (a.JavaScript = function(a, b, c) {
            ...
            eval: function(b) {
                var c,
                    d = this,
                    e = {},
                    f = this.expression.replace(/@\{([\w-]+)\}/g, function(
                        c,
                        e
                    ) {
                        return a.jsify(
                            new a.Variable("@" + e, d.index).eval(b)
                        );
                    });
                try {
        ...
        (a.Keyword = function(a) {
            ...
            compare: function(b) {
                return b instanceof a.Keyword
                    ? b.value === this.value ? 0 : 1
                    : -1;
            }
        }), (a.True = new a.Keyword("true")), (a.False = new a.Keyword(
            "false"
        ));
    })(c("../tree")), (function(a) {
        (a.Media = function(b, c) {
            var d = new a.Element("&", null, 0),
                e = [new a.Selector([d])];
            (this.features = new a.Value(c)), (this.ruleset = new a.Ruleset(
                e,
                b
            )), (this.ruleset.allowImports = !0);
        }), (a.Media.prototype = {
            toCSS: function(a, b) {
                ...
                return (this.ruleset.root =
                    a.length === 0 || a[0].multiMedia), "@media " +
                    c +
                    (b.compress ? "{" : " {\n  ") +
            ...
            eval: function(b) {
                ...
                var d = new a.Media([], []);
                return (d.features = this.features.eval(b)), b.frames.unshift(
                    this.ruleset
                ), (d.ruleset = this.ruleset.eval(
                    b
                )), b.frames.shift(), (b.mediaBlocks[
                    c
                ] = d), b.mediaPath.pop(), b.mediaPath.length === 0
                    ? d.evalTop(b)
                    : d.evalNested(b);
            },
            variable: function(b) {
                ...
                for (c = 0; c < e.length; c++)
                    (d =
                        e[c].features instanceof a.Value
                            ? e[c].features.value
                            : e[c].features), (e[c] = Array.isArray(d)
                        ? d
                        : [d]);
                return (this.features = new a.Value(
        ...
        (a.mixin = {}), (a.mixin.Call = function(b, c, d, e, f) {
            (this.selector = new a.Selector(
                b
            )), (this.arguments = c), (this.index = d), (this.filename = e), (this.important = f);
            ...
            (this.name = b), (this.selectors = [
                new a.Selector([new a.Element(null, b)])
            ]), (this.params = c), (this.condition = e), (this.variadic = f), (this.arity =
                c.length), (this.rules = d), (this._lookups = {}), (this.required = c.reduce(
                function(a, b) {
                    return !b.name || (b.name && !b.value) ? a + 1 : a;
                },
                0
            )), (this.parent = a.Ruleset.prototype), (this.frames = []);
                    ...
                    if ((h = this.params[f].name))
                        if (this.params[f].variadic && c) {
                            ...
                            for (var i = f; i < c.length; i++)
                                e.push(c[i].eval(b));
                            d.rules.unshift(
                                new a.Rule(h, new a.Expression(e).eval(b))
                            );
            ...
            eval: function(b, c, d) {
                ...
                for (
                    var j = 0;
                    j < Math.max(this.params.length, c && c.length);
                    j++
                )
                    g.push(c[j] || this.params[j].value);
                return e.rules.unshift(
            ...
            match: function(a, b) {
                ...
                for (var f = 0; f < d; f++)
                    if (
                        !this.params[f].name &&
                        a[f].eval(b).toCSS() !=
                            this.params[f].value.eval(b).toCSS()
                    )
                        return !1;
                return !0;
            }
        ...
        (a.Quoted = function(a, b, c, d) {
            (this.escaped = c), (this.value = b || ""), (this.quote = a.charAt(
                0
            )), (this.index = d);
        }), (a.Quoted.prototype = {
            toCSS: function() {
                ...
                var c = this,
                    d = this.value
                        .replace(/`([^`]+)`/g, function(d, e) {
                            return new a.JavaScript(e, c.index, !0).eval(
                                b
                            ).value;
                        })
        ...
        (a.Rule = function(b, c, d, e, f) {
            (this.name = b), (this.value =
                c instanceof a.Value
                    ? c
                    : new a.Value([c])), (this.important = d
                ? " " + d.trim()
                : ""), (this.index = e), (this.inline = f || !1), b.charAt(
                0
            ) === "@"
                ? (this.variable = !0)
                : (this.variable = !1);
        ...
        (a.Ruleset = function(a, b, c) {
            ...
            eval: function(b) {
                ...
                (d.root = this.root), (d.allowImports = this.allowImports), b.frames.unshift(
                    d
                );
                if (d.root || d.allowImports || !d.strictImports)
                    for (var e = 0; e < d.rules.length; e++)
                        d.rules[e] instanceof a.Import &&
                            Array.prototype.splice.apply(
                                d.rules,
                                [e, 1].concat(d.rules[e].eval(b))
                            );
                for (var e = 0; e < d.rules.length; e++)
                    d.rules[e] instanceof a.mixin.Definition &&
                        (d.rules[e].frames = b.frames.slice(0));
                for (var e = 0; e < d.rules.length; e++)
                    d.rules[e] instanceof a.mixin.Call &&
                        Array.prototype.splice.apply(
                            d.rules,
                            [e, 1].concat(d.rules[e].eval(b))
                        );
                for (var e = 0, f; e < d.rules.length; e++)
                    (f = d.rules[e]), f instanceof a.mixin.Definition ||
                        (d.rules[e] = f.eval ? f.eval(b) : f);
            ...
            rulesets: function() {
                return this._rulesets
                    ? this._rulesets
                    : (this._rulesets = this.rules.filter(function(b) {
                          return (
                              b instanceof a.Ruleset ||
                              b instanceof a.mixin.Definition
                          );
                      }));
            },
            find: function(b, c) {
            ...
            toCSS: function(b, c) {
                ...
                this.root ||
                    (b.length === 0
                        ? (g = this.selectors.map(function(a) {
                              return [a];
                          }))
                        : this.joinSelectors(g, b, this.selectors));
                for (var j = 0; j < this.rules.length; j++)
                    (i = this.rules[j]), i.rules ||
                    i instanceof a.Directive ||
                    i instanceof a.Media
                        ? f.push(i.toCSS(g, c))
                        : i instanceof a.Comment
                          ? i.silent ||
                            (this.root
                                ? f.push(i.toCSS(c))
                                : e.push(i.toCSS(c)))
                          : i.toCSS && !i.variable
                            ...
                            : i.value &&
                              !i.variable &&
                              e.push(i.value.toString());
                return (f = f.join("")), this.root
                    ? d.push(e.join(c.compress ? "" : "\n"))
                    : e.length > 0 &&
                      (
                          (h = g
                              .map(function(a) {
            ...
            joinSelector: function(b, c, d) {
                ...
                for (var k = 0; k < d.elements.length; k++)
                    (j = d.elements[k]), j.combinator.value.charAt(0) === "&" &&
                        (i = !0), i ? h.push(j) : g.push(j);
                i || ((h = g), (g = [])), g.length > 0 &&
                    e.push(new a.Selector(g)), h.length > 0 &&
                    f.push(new a.Selector(h));
        ...
        (a.Selector = function(a) {
            (this.elements = a), this.elements[0].combinator.value === "" &&
        ...
        (b.URL = function(b, c) {
            ...
            eval: function(a) {
                return this.attrs
                    ? this
                    : new b.URL(this.value.eval(a), this.paths);
            }
        });
    })(c("../tree")), (function(a) {
        (a.Value = function(a) {
    ...
    (d.env =
        ...
        ? (
              (d.optimization = 0),
              /!watch/.test(location.hash) && d.watch(),
              (d.watchTimer = setInterval(function() {
                  d.watchMode &&
    ...
    for (var k = 0; k < i.length; k++)
        (i[k].rel === "stylesheet/less" ||
            (i[k].rel.match(/stylesheet/) && i[k].type.match(j))) &&
            d.sheets.push(i[k]);
    (d.refresh = function(a) {
        var b, c;
        (b = c = new Date()), m(function(a, d, e, f, g) {
            g.local
                ? t("loading " + f.href + " from cache.")
                : (
                      t("parsed " + f.href + " successfully."),
                      p(d.toCSS(), f, g.lastModified)
                  ), t("css for " + f.href + " generated in " + (new Date() - c) + "ms"), g.remaining === 0 && t("css generated in " + (new Date() - b) + "ms"), (c = new Date());
        }, a), l();
