---
title: How to Launch Angular for Development from Visual Studio
...
banner: /images/launch.jpg
bannerCredit: Photo by [SpaceX](https://unsplash.com/photos/TV2gg2kZD1o)
---
...
```xml title=FrontEnd.njsproj {4-6}
<PropertyGroup>
    <Configuration Condition=" '$(Configuration)' == '' ">Debug</Configuration>
    // ...
    <StartupFile>node_modules\@angular\cli\bin\ng</StartupFile>
